...
const ActiveCard = ({ image, title, day, hour, min }) => {
  return (
    <div className="w-[354px] h-[473px] rounded-[15px]   bg-[#ffffff]">
      <img className="w-[354px] h-[174px]" src={image} alt="" />
      <div className="  bg-green-200 h-[21px] w-[87px] rounded-[5px] ml-[133px] mt-[25px] ">
        <p className=" text-[12px] font-inter font-[400] text-center  leading-[16px]  text-green-700">
          Active
        </p>
      </div>
